...
#if 1
const uint16_t UT_REGISTERS_ADDRESS = 2; // should be started from 2
const uint16_t UT_REGISTERS_NB = 0x19;
const uint16_t UT_REGISTERS_NB_MAX = MODBUS_MAX_WR_WRITE_REGISTERS; //121
